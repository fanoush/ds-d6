...
I got it from GearBest however it now appears to be permanently out of stock on their website (e.g. [here](https://uk.gearbest.com/smart-watches/pp_1232618.html)). Sometimes it can be also found on ebay but the prices vary and can be relatively high so it may make sense to get some other device mentioned below (e.g. F07/F10, or HX03W if you need gpio on usb data pins, or P8). If you would still need/want DS-D6 and cannot get it elsewhere then PM me on gitter or ask in the Lobby. I guess I could part with few from my private stock if you are EU based and maybe others could too.
